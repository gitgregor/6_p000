...
class App extends Component {
  ...
  render() {
    ...
    const bands = [
      ...
      { label: 'Incant', from: 3, to: 6 },
      { label: 'XnosreP', from: 6, to: 9 },
      { label: 'Read.', from: 9, to: 12 },
      { label: 'glitch', from: 12, to: 14 },
      { label: 'null', from: 14, to: 18 },
      { label: 'event', from: 18, to: 21 },
      { label: 'workshop', from: 21, to: 35 }
    ];
      ...
      <div className="app">
        <HighchartsProvider Highcharts={Highcharts}>
          <HighchartsChart plotOptions={plotOptions}>
            ...
            <Title>Takie Story</Title>

            <Subtitle>Child in Time :)</Subtitle>
            ...
            <YAxis minorGridLineWidth={0} gridLineWidth={0} alternateGridColor={null}>
              ...
              <SplineSeries name="Incant" data={[0, 0, 0, 5, 2, 4, 3.8, 4.2]} />
              {/* <SplineSeries name="Inicjalizacja" data={[4, 3, 6, 5, 2, 4, 3, 2, 5, 3.5]} /> */}
              <SplineSeries name="XnosreP" data={[0,0,0,0,0,6,9,7,8,7.5]} />
              <SplineSeries name="Read" data={[0,9,10,12,11,10,10]} />
              <SplineSeries name="glitch" data={[0,0,0,0,12,14,13]} />
              <SplineSeries name="null" data={[0,0,17,0,0,0,0,18, 14]} />
              <SplineSeries name="event" data={[0,0,0,18,19,21]} />
              <SplineSeries name="workshop" data={[23, 25, 24, 22]} />
