...
class App extends Component {
  ...
  render() {
    ...
    const bands = [
      { label: 'Producent', from: 0.5, to: 3 },
      { label: 'Inicjalizacja', from: 3, to: 6 },
      { label: 'Personalizacja', from: 6, to: 9 },
      { label: 'Gotow. B.', from: 9, to: 12 },
      { label: 'Error', from: 12, to: 14 },
      { label: 'Do Wyzerowania', from: 14, to: 18 },
      { label: 'Incydent', from: 18, to: 21 },
      { label: 'Warsztat', from: 21, to: 35 }
    ];
      ...
      <div className="app">
        <HighchartsProvider Highcharts={Highcharts}>
          <HighchartsChart plotOptions={plotOptions}>
            ...
            <Title>Historia Życia Urządzenia</Title>

            <Subtitle>Cykl zdarzeń w czasie</Subtitle>
            ...
            <YAxis minorGridLineWidth={0} gridLineWidth={0} alternateGridColor={null}>
              <YAxis.Title>Cykl Życia Urządzenia</YAxis.Title>
              <SplineSeries name="Producent" data={[1, 3, 2, 2.5, 1, 1, 3, 2, 2.9, 1.5]} />
              <SplineSeries name="Inicjalizacja" data={[0, 0, 0, 5, 2, 4, 3.8, 4.2]} />
              {/* <SplineSeries name="Inicjalizacja" data={[4, 3, 6, 5, 2, 4, 3, 2, 5, 3.5]} /> */}
              <SplineSeries name="Personalizacja" data={[0,0,0,0,0,6,9,7,8,7.5]} />
              <SplineSeries name="Gotow. B." data={[0,9,10,12,11,10,10]} />
              <SplineSeries name="Error" data={[0,0,0,0,12,14,13]} />
              <SplineSeries name="Do Wyzerowania" data={[0,0,17,0,0,0,0,18, 14]} />
              <SplineSeries name="Incydent" data={[0,0,0,18,19,21]} />
              <SplineSeries name="Warsztat" data={[23, 25, 24, 22]} />
